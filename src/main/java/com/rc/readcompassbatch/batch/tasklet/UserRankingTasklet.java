...
public class UserRankingTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        RankingResult result = rankingService.calculateUserRankings(calculatedAt);
        metrics.recordRankingsSaved("user", result.rankingsSaved());
