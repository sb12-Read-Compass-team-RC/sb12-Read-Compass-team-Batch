...
public class BookRankingTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        ...
        RankingResult result = rankingService.calculateBookRankings(calculatedAt);
        metrics.recordRankingsSaved("book", result.rankingsSaved());
